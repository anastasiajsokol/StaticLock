(function(e) {
  if ("function" == typeof bootstrap) bootstrap("fernet", e);
  else if ("object" == typeof exports) module.exports = e();
  else if ("function" == typeof define && define.amd) define(e);
  else if ("undefined" != typeof ses) {
      if (!ses.ok()) return;
      ses.makeFernet = e
  } else "undefined" != typeof window ? window.fernet = e() : global.fernet = e()
})(function() {
          ...
          1: [function(require, module, exports) {
              ...
              var fernet = function fernet(opts) {
                  ...
                  this.encryptMessage = function(message, encryptionKey, iv) {
                      var encrypted = AES.encrypt(message, encryptionKey, {
                          iv: iv
                      });
                  ...
                  this.decryptMessage = function(cipherText, encryptionKey, iv) {
                      ...
                      var decrypted = AES.decrypt(encrypted, encryptionKey, {
                          iv: iv
                      });
              ...
              "./lib/secret": 2,
              "./lib/token": 3,
              "__browserify_Buffer": 29,
              "crypto": 11,
              "crypto-js/aes": 16,
              "crypto-js/core": 18,
              "crypto-js/enc-base64": 19,
              "crypto-js/enc-hex": 20,
              "crypto-js/enc-latin1": 21,
              "crypto-js/enc-utf8": 22,
              "crypto-js/hmac-sha256": 24,
              "urlsafe-base64": 31
          }],
    ...
    list should be an Array.");
          ...
          29: [function(require, module, exports) {
              require = (function(e, t, n, r) {
                  ...
                  "buffer-browserify": [function(require, module, exports) {
